...
![alt whenInteracting](images/whenInteracting.png) {:height="36px" width="36px"}

When items are added to the list, they are listed with the latest item shown on top.

![alt afterAddingItems](images/afterAddingItems.png){:height="36px" width="36px"}
...
![alt afterDelete](images/afterDelete.png) <!-- .img height="50%" width="50%" -->
...
![alt inlineEdit](images/inlineEdit.png) <!-- .img height="50%" width="50%" -->
...
![alt inlineEditConfirm](images/inlineEditConfirm.png) <!-- .img height="50%" width="50%" -->

#### Resetting the entire ToDo list
On clicking the `Reset List` button the entire list is reset and all the tasks are removed.

![alt afterReset](images/afterReset.png) <!-- .img height="50%" width="50%" -->
